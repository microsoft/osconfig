...
- [DeviceInfo](DeviceInfo.md) - Device information (manufacturer, BIOS, etc.)
...
- [FilePermission](linux/FilePermission.md) - File permissions, ownership, and group
- [KernelModule](linux/KernelModule.md) - Kernel module loading and unloading
- [User](linux/User.md) - Local user account configuration
